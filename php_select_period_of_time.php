...
function incomes ($connect, $id , $value, $start_date, $end_date) {
	...
	$result = $connect->query("SELECT SUM(amount) FROM incomes AS inc INNER JOIN incomes_category_assigned_to_user AS ic ON inc.income_category_assigned_to_user_id = ic.id AND ic.name = '$value' AND inc.user_id = ic.user_id AND date_of_income BETWEEN '$start_date' AND '$end_date' AND inc.user_id = '$id'");
...
function expenses ($connect, $id , $value, $start_date, $end_date) {
	...
	$result = $connect->query("SELECT SUM(amount) FROM expenses AS exp INNER JOIN expenses_category_assigned_to_user AS ec ON exp.expenses_category_assigned_to_user_id = ec.id AND ec.name = '$value' AND exp.user_id = ec.user_id AND date_of_expense BETWEEN '$start_date' AND '$end_date' AND exp.user_id = '$id'");
